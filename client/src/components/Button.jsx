...
const base =
  'inline-flex items-center justify-center gap-2 rounded px-4 py-2 font-sans font-medium transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-60';
